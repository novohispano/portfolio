{
  ...
  :code => {
    ...
    :project_2 => {
      :title => "StreamRolled",
      :description => "This project brings back the feeling of browsing through a crate of your old records. Using Twitter OAuth, and intergrating with Soundcloud & LastFM accounts, this application organizes your music habits in a 'pintrest' style wall where you can post, play, and explore new music.",
      :url => 'https://github.com/SerKnight/feed_engine',
      :what_to_look_for => ['AJAX content uploading', 'Masonry jQuery library', 'Very custom HTML & CSS'],
    },
    :project_3 => {
      :title => "Hacktivism",
