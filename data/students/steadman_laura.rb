{
  ...
  :code => {
    ...
    :project_1 => {
      :title => "Trekkr",
      :description => "Trekkr encourages users to experience a virtual hike by viewing geo-tagged Instagram photos mapped along the Pacific Crest Trail. Please visit it live at: http://trekkr.herokuapp.com",
    ...
    :project_2 => {
      :title => "Photoline",
      :description => "Users can create and share custom photo feeds based on aggregated keyword searches or specific users, providing a topic-centric browsing experience. See it live at: http://photoline-feed.us",
    ...
    :project_3 => {
      ...
      :what_to_look_for => ['full-spectrum testing (TDD) on all added or refactored features','testing with FactoryGirl', 'jQuery ajax']
    }
  },
